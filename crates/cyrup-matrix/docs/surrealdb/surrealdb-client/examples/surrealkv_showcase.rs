...
use surrealdb_client::{
    connect_database, open_surrealkv_store, BaseDao, Dao, DatabaseClient, DbConfig, Entity, Error,
    StorageEngine,
};
...
// BaseEntity isn't re-exported in lib.rs, so we'll define a simple version here
