...
static QUERY_DURATIONS: Lazy<Arc<Mutex<Vec<Duration>>>> = Lazy::new(|| Arc::new(Mutex::new(Vec::new())));
static MUTATION_DURATIONS: Lazy<Arc<Mutex<Vec<Duration>>>> = Lazy::new(|| Arc::new(Mutex::new(Vec::new())));
