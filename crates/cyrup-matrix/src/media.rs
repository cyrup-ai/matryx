...
impl CyrumMedia {
    ...
    pub fn upload(&self, content_type: &str, data: Vec<u8>, filename: Option<&str>) -> MatrixFuture<String> {
        ...
        MatrixFuture::spawn(async move {
            ...
            let mut request = matrix_sdk::ruma::api::client::media::create_content::v3::Request::new(data);
    ...
    pub fn download(&self, mxc_uri: &str) -> MatrixFuture<Vec<u8>> {
        ...
        MatrixFuture::spawn(async move {
            ...
            let response = client.media().get_media_content(&request, true).await
                .map_err(MediaError::matrix_sdk)?;
    ...
    pub fn get_thumbnail_url(&self, mxc_uri: &str, width: u32, height: u32) -> Option<String> {
        ...
        client.media().get_content_thumbnail_url(&uri, thumbnail_settings).map(|url| url.to_string())
    }
}