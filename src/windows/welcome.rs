...
use crate::base::IambBufferId;
use crate::cyrum_window::{
    ActionResult, CyrumWindow, EditableWindow, EditableWindowState, ScrollDirection, WindowComponent,
};
use crate::modal::{
    CyrumAction, EditorAction, InputEvent, ModalState, WindowAction, WindowActionTrait,
};
...
impl WelcomeState {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            id: IambBufferId::Welcome.to_string(),
            focused: false,
        }
    }
}
...
impl CyrumWindow for WelcomeWindow {
    fn id(&self) -> &str {
        &self.state.id
    }
    ...
    fn execute_cyrum_action(&mut self, _action: CyrumAction) -> ActionResult {
        Ok(None) // No Cyrum-specific actions in welcome window
    }
}
