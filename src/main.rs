//! # cyrum
//!
//! The cyrum client loops over user input and commands, and turns them into actions, [some of
//! which][IambAction] are specific to cyrum, and [some of which][Action] come from [modalkit]. When
...
fn main() -> IambResult<()> {
    ...
    let log_prefix = format!("cyrum-log-{}", settings.profile_name);
