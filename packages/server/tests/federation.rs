...
use common::integration::federation::*;
...
async fn test_federation_endpoints() {
    ...
    let federation_test = FederationTest::new()
        .await
...
async fn test_federation_event_handling() {
    ...
    let event_test = FederationEventTest::new()
        .await
...
async fn test_multi_server_federation() {
    ...
    let fed_response1 = federation_test
        .server1
        .test_endpoint("GET", "/_matrix/federation/v1/version", None)
        .await;
    let fed_response2 = federation_test
        .server2
        .test_endpoint("GET", "/_matrix/federation/v1/version", None)
        .await;
