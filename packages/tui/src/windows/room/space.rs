...
use crate::base::{maxtryxBufferId, maxtryxInfo, ProgramStore, RoomFocus};
...
pub struct SpaceState {
    room_id: OwnedRoomId,
    room: MatrixRoom,
    list: ListState<RoomItem, maxtryxInfo>,
...
impl SpaceState {
    pub fn new(room: MatrixRoom) -> Self {
        ...
        let content = maxtryxBufferId::Room(room_id.clone(), None, RoomFocus::Scrollback);
...
impl Deref for SpaceState {
    type Target = ListState<RoomItem, maxtryxInfo>;
